...
Prepares the server with base packages and the pressctl system user.

## What It Does

- Creates the `pressctl` system user for administration
...
```yaml
pressctl_ssh_key: '~/.ssh/pressctl.pub' # or paste key directly
```
